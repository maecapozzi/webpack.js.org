...
In the example above we are describing to webpack the name of our bundle and where we want it to be emitted to through the `output.filename` and `output.path` properties.
